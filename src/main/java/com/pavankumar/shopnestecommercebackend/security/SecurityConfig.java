...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain filterChain(HttpSecurity http, RateLimitFilter rateLimitFilter, GoogleOAuth2SuccessHandler googleOAuth2SuccessHandler) throws Exception{
    ...
    public CorsConfigurationSource corsConfigurationSource(){
        ...
        configuration.setAllowedHeaders(List.of(frontendUrl));
